...
from .routers import artists, auth, calendar, metube, navidrome, releases, search, settings, stats, tagging
...
app.include_router(navidrome.router, dependencies=protected)
